...
## Default origin when user says only destination, ex- "Goa trip"
...
def clean_text(text: str)->str:
    ...
    ## most common stop word that not userful to search
    stop_words = [
...
def country_name_to_code(text: str):
    ...
    for country in pycountry.countries:
        coutnry_name= country.name.lower()
        if coutnry_name in text:
            return country.alpha_2
